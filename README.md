...
I built this lab to understand the backend logic of alerts so i can be more effective in real triage situations.
...
1. Atomic Red Team(By Red canary) - attack libary based on MITRE tactics, used for testing
   rules detection.
2. Sysmon agent on windows endpoint for collecting and monitoring precise logs of the system. 
